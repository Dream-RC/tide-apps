...
import { WorkflowFormSchemaType } from "../data/workflow-form-schema";

export const workflowFormColumns = (
    openForm?: (type: string, id?: number) => void,
): ColumnDef<WorkflowFormSchemaType>[] => [
    {
        accessorKey: "name",
        header: ({ table }) => (
...
// 添加默认导出
export default workflowFormColumns;
