...
import { UserLoginVO } from '@/common/api/login/types';
...
const onSubmit = handleSubmit(async (values) => {
    ...
    try {
        const result = await LoginApi.login(values as UserLoginVO)
        console.log(result)
        ...
        <Card class="overflow-hidden">
            <CardContent class="grid p-0 md:grid-cols-2">
                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="grid gap-2">
                            <FormField v-slot="{ componentField }" name="username">
                                <FormItem>
                                    <FormLabel for="username">邮箱地址</FormLabel>
                                    <FormControl>
                        ...
                        <div class="grid gap-2">
                            <FormField v-slot="{ componentField }" name="password">
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input type="password" placeholder="请输入密码" v-bind="componentField" required />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            </FormField>
                ...
                <div class="relative hidden  md:block">
                    <img src="@/assets/bg_image/login_bg.svg" alt="Image"
