...
import { MemberLevelSchema } from "../data/member-level-schema";

export const memberLevelColumns = (): ColumnDef<MemberLevelSchema>[] => [
    {
        accessorKey: "name",
        header: ({ table }) => (
        ...
        cell: ({ row }) => {
            ...
            return (
                <div className=" gap-3 flex justify-center items-center">
                    <router-link to={`/member/level/form/` + row.original.id}>
                        <Button
                            size="sm"
                            variant="outline"
                        >
...
// 添加默认导出
export default memberLevelColumns;
